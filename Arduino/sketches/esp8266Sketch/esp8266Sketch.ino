...
// MQTT broker details
const char *mqtt_server_ip = "***.***.***.***"; // Set the MQTT Server IP address
const int mqtt_port = 1883; // Set the /MQTT Server port
const char *mqtt_username = "******"; // Set the login credentials
...
const char *ssid = "******"; // Set the SSID 
const char *password = "******"; // Set the password
